...
function getRoleId(envKey: string, fallback: string): string {
...
export function getOwnerRoleId(): string {
...
export function isStaff(member: GuildMember): boolean {
  return (
    member.roles.cache.has(getStaffRoleId()) ||
...
export function isOwner(member: GuildMember): boolean {
  return (
    member.roles.cache.has(getOwnerRoleId()) ||
...
export function hasRoleHierarchy(invoker: GuildMember, target: GuildMember): boolean {
