...
export default {
  ...
  async execute(interaction: any) {
    ...
    try {
      ...
      if (scriptUrl) updates.scriptUrl = scriptUrl;
      if (description) updates.description = description;
      if (category) updates.category = category;
      if (active !== null) updates.isActive = active;
      if (free !== null) updates.free = free;
      if (keyRequired !== null) updates.keyRequired = keyRequired;
      if (mobileCompatible !== null) updates.mobileCompatible = mobileCompatible;
